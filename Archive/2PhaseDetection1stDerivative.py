...
for daily in range(len(days)):
    ...
    #
    # plt.scatter([var1[i] for i in capturedPoints], [derivativeSum[j] for j in range(len(derivativeSum))], marker='.', color=(0.0, 0.9, 0.9),                s=7)
    plt.scatter([var1[i] for i in capturedPoints], [derivativeSum[j] for j in range(len(derivativeSum))], marker='.', color=(0.0, 0.5, 0.9),                s=7)
    print(len(var1), len(derivativeSumFull))
    plt.scatter(var1[timeGap:], derivativeSumFull, marker='.', color=(0.5, 0.2, 0.2),                s=7)
